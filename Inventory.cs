...
public class Inventory
{
    ...
    public void GiveStarterItems()
    {
        ...
        SetSlot(3, new Tool("watering_can", "Watering Can", "Waters crops.", resourceCost: 1f, powerLevel: 1));
        ...
        SetSlot(6, new Tool("hydro_wand", "Hydro Wand", "Conjures water to nourish crops.", resourceCost: 1f, powerLevel: 2));
